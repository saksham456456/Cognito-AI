...
const translations: any = {
  en: {
    ...
    coding: { title: "CODE CORE INTERFACE", exit: "Disengage Core", run: "Run", running: "RUNNING...", initializing: "INITIALIZING...", copyCode: "Copy Code", copied: "Code Copied", consoleHeader: "// CONSOLE OUTPUT", assistantHeader: "// AI ASSISTANT", awaitingExecution: "[Awaiting execution...]", assistantPlaceholder: "Ask the assistant...", toggleAssistant: "Toggle Assistant" },
    ...
    live: { connecting: "Establishing secure audio channel...", listening: "Listening...", speakNow: "Speak now", processing: "Processing...", disconnect: "Disconnect", error: "Connection Error", micError: "Microphone access denied. Please enable it in your browser settings.", muted: "Muted", retrying: "Connection error. Retrying in {{delay}}s... ({{current}}/{{max}})", retryFailed: "Connection failed after multiple retries." },
  },
  es: {
    ...
    coding: { title: "INTERFAZ DEL NÚCLEO DE CÓDIGO", exit: "Desconectar Núcleo", run: "Ejecutar", running: "EJECUTANDO...", initializing: "INICIALIZANDO...", copyCode: "Copiar Código", copied: "Código Copiado", consoleHeader: "// SALIDA DE LA CONSOLA", assistantHeader: "// ASISTENTE DE IA", awaitingExecution: "[Esperando ejecución...]", assistantPlaceholder: "Pregúntale al asistente...", toggleAssistant: "Alternar Asistente" },
    ...
    languages: { en: "English", es: "Español", hi: "हिन्दी", fr: "Français", sa: "संस्कृतम्", 'hi-en': "Hinglish" },
    live: { connecting: "Estableciendo canal de audio seguro...", listening: "Escuchando...", speakNow: "Hable ahora", processing: "Procesando...", disconnect: "Desconectar", error: "Error de Conexión", micError: "Acceso al micrófono denegado. Por favor, habilítelo en la configuración de su navegador.", muted: "Silenciado", retrying: "Error de conexión. Reintentando en {{delay}}s... ({{current}}/{{max}})", retryFailed: "La conexión falló después de múltiples reintentos." }
  },
  hi: {
    ...
    chatInput: { placeholderCognito: "कॉग्निटो को संदेश भेजें...", placeholderCode: "कोडिंग प्रश्न पूछें...", shiftEnter: "नई लाइन के लिए Shift + Enter दबाएं।", suggestions: ["Draft a blueprint for a cyberpunk megacity", "Write a log entry from a starship captain discovering a new planet", "Invent a piece of futuristic technology and describe it", "Explain the concept of a neural network like I'm a detective", "Design a database schema for a colony on Mars", "Optimize this Python code for quantum processors", "What is the future of human-AI collaboration?", "Discuss the ethics of sentient machines", "Write a poem about the loneliness of data"], modeCognito: "कॉग्निटो इंटरफेस", modeCognitoDesc: "सामान्य प्रश्नों के लिए संवादी एआई।", modeCode: "कोड कोर", modeCodeDesc: "कोड और एल्गोरिदम के लिए विशेष इंटरफ़ेस।", selectMode: "इंटरफ़ेस चुनें", liveConversation: "टॉकिंग मोड" },
    welcome: {
      messages: [
    ...
    coding: { title: "कोड कोर इंटरफ़ेस", exit: "कोर से अलग हों", run: "चलाएँ", running: "चल रहा है...", initializing: "शुरू हो रहा है...", copyCode: "कोड कॉपी करें", copied: "कोड कॉपी किया गया", consoleHeader: "// कंसोल आउटपुट", assistantHeader: "// एआई सहायक", awaitingExecution: "[निष्पादन की प्रतीक्षा में...]", assistantPlaceholder: "सहायक से पूछें...", toggleAssistant: "सहायक टॉगल करें" },
    ...
    languages: { en: "English", es: "Español", hi: "हिन्दी", fr: "Français", sa: "संस्कृतम्", 'hi-en': "Hinglish" },
    live: { connecting: "सुरक्षित ऑडियो चैनल स्थापित हो रहा है...", listening: "सुन रहा है...", speakNow: "अब बोलें", processing: "संसाधित हो रहा है...", disconnect: "डिस्कनेक्ट", error: "कनेक्शन त्रुटि", micError: "माइक्रोफ़ोन एक्सेस अस्वीकृत। कृपया इसे अपनी ब्राउज़र सेटिंग्स में सक्षम करें।", muted: "म्यूट", retrying: "कनेक्शन में त्रुटि। {{delay}}s में पुन: प्रयास कर रहा है... ({{current}}/{{max}})", retryFailed: "कई बार पुन: प्रयास करने के बाद कनेक्शन विफल हो गया।" }
  },
  fr: {
    ...
    coding: { title: "INTERFACE DU NOYAU DE CODAGE", exit: "Désengager le Noyau", run: "Exécuter", running: "EXÉCUTION...", initializing: "INITIALISATION...", copyCode: "Copier le Code", copied: "Code Copié", consoleHeader: "// SORTIE CONSOLE", assistantHeader: "// ASSISTANT IA", awaitingExecution: "[En attente d'exécution...]", assistantPlaceholder: "Demandez à l'assistant...", toggleAssistant: "Afficher/Masquer l'Assistant" },
    ...
    languages: { en: "English", es: "Español", hi: "हिन्दी", fr: "Français", sa: "संस्कृतम्", 'hi-en': "Hinglish" },
    live: { connecting: "Établissement du canal audio sécurisé...", listening: "Écoute...", speakNow: "Parlez maintenant", processing: "Traitement...", disconnect: "Déconnecter", error: "Erreur de Connexion", micError: "Accès au microphone refusé. Veuillez l'activer dans les paramètres de votre navigateur.", muted: "Muet", retrying: "Erreur de connexion. Nouvelle tentative dans {{delay}}s... ({{current}}/{{max}})", retryFailed: "La connexion a échoué après plusieurs tentatives." }
  },
  sa: {
    ...
    coding: { title: "कूट-केन्द्र-अन्तरापृष्ठम्", exit: "केन्द्रं त्यजतु", run: "चालयतु", running: "चलति...", initializing: "आरभ्यमाणम्...", copyCode: "कूटं प्रतिलिपिं करोतु", copied: "कूटं प्रतिलिपिः कृतः", consoleHeader: "// कन्सोल-आउट्पुट्", assistantHeader: "// एआई-सहायकः", awaitingExecution: "[निष्पादनं प्रतीक्षमाणम्...]", assistantPlaceholder: "सहायकं पृच्छतु...", toggleAssistant: "सहायकं परिवर्तयतु" },
    ...
    languages: { en: "English", es: "Español", hi: "हिन्दी", fr: "Français", sa: "संस्कृतम्", 'hi-en': "Hinglish" },
    live: { connecting: "सुरक्षित-ध्वनि-चैनलं स्थाप्यते...", listening: "शृण्वन्...", speakNow: "अधुना वदतु", processing: "संसाधनं कुर्वन्...", disconnect: "वियोजयतु", error: "सम्पर्क-त्रुटिः", micError: "माइक्रोफोन्-प्रवेशः निषिद्धः। कृपया भवतः ब्राउजर्-सेटिङ्ग्स् मध्ये तत् समर्थयतु।", muted: "मौनम्", retrying: "सम्पर्क-त्रुटिः। {{delay}}s मध्ये पुनः प्रयतते... ({{current}}/{{max}})", retryFailed: "बहु-प्रयत्नानन्तरं सम्पर्कः विफलः अभवत्।" }
  },
  'hi-en': {
    ...
    coreDisintegration: { title: "DISENGAGING CODING CORE", shutdownLog: ["[SYS] SHUTDOWN SEQUENCE INITIATED...", "[MEM] VIRTUAL MEMORY DEALLOCATED", "[CPU] RELEASING PROCESSOR KERNELS", "[NET] SECURE LINK TERMINATED", "[UI] DISENGAGING GRAPHICAL SHELL...", "[OK] CORE SHUTDOWN COMPLETE.", "[SYS] RETURNING TO COGNITO INTERFACE."] },
    languages: { en: "English", es: "Español", hi: "हिन्दी", fr: "Français", sa: "संस्कृतम्", 'hi-en': "Hinglish" },
    live: { connecting: "Secure audio channel establish ho raha hai...", listening: "Sun raha hai...", speakNow: "Ab boliye", processing: "Processing...", disconnect: "Disconnect", error: "Connection Error", micError: "Microphone access denied. Please browser settings me enable karein.", muted: "Muted", retrying: "Connection error. {{delay}}s mein retry kar raha hai... ({{current}}/{{max}})", retryFailed: "Multiple retries ke baad connection fail ho gaya." }
  }
};
    ...
    useEffect(() => {
        const init = async () => {
            try {
                ...
                const minLoadingTime = 5500; // Show the loading screen for a minimum of 5.5 seconds.
